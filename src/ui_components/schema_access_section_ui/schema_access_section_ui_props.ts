...
const SchemaAccessSectionUIProps   = {
    ...
    body_section_row_class_style: { type: String, default: ui_class_styles?.body_section?.row_body?.row_class_style ?? "", required: false },


}

export default SchemaAccessSectionUIProps;