...
<template>
    <section id="DatasourceListView" :class="props?.section_wrapper_class_style">
...
import DatasourceListViewProps       from "./datasource_list_view_props";
import DatasourceListViewController  from "./datasource_list_view_controller";

const props            = defineProps(DatasourceListViewProps);
const controller       = new DatasourceListViewController(props)
