<template>
    <section id="DatasourceListView" :class="props?.wrapper_class_style">
        ...
        <div :class="props.info_section_wrapper_class_style">
            <span :class="props.key_text_class_style">
                {{ content_data?.database_name_type_key_text }}:
            </span>
        ...
        <div :class="props.info_section_wrapper_class_style">
            <span :class="props.key_text_class_style">
                {{ content_data?.is_created_key_text }}:
            </span>
            <span :class="props.value_text_class_style">
                {{ props.record.is_created ? content_data?.created_value_text : content_data?.destroyed_value_text }}
            </span>
        </div>
        ...
        <div :class="props.info_section_wrapper_class_style">
            <span :class="props.key_text_class_style">
                {{ content_data?.connection_info_key_text }}:
            </span>
