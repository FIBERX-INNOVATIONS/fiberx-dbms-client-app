...
class TwoFactorLoginViewPropsBuilder {
    public readonly name = "two_factor_login_view_props_builder";

    // Method to get header text
    public static getHeaderText (): string {
        const content_manager   = ContentManagerUtil.getInstance();
        const content_data      = content_manager.get("content_resource.two_factor_login_view_ui");
    ...
    public static getOTPInputGroupProps (event_handler: BaseEventHandlerInterface): InputGroupPropsInterface {
        const content_manager   = ContentManagerUtil.getInstance();
        ...
        const { otp_label_text, otp_placeholder_text } = content_data;
    ...
    public static getBtnProps (
        ...
        const on_click              = event_handler?.handleTwoFactorLoginSubmitBtnClick.bind(event_handler);
...
export default TwoFactorLoginViewPropsBuilder;