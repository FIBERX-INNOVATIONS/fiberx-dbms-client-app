...
<template>
    <section id="AccessControlRoleListView" :class="props?.section_wrapper_class_style">
...
import AccessControlRoleListViewProps       from "./access_control_role_list_view_props";
import AccessControlRoleListViewController  from "./access_control_role_list_view_controller";

const props            = defineProps(AccessControlRoleListViewProps);
const controller       = new AccessControlRoleListViewController(props)
