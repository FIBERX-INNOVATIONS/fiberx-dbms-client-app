...
<template>
    <section id="SchemaAccessListView" :class="props?.section_wrapper_class_style">
        ...
        <section id="ListDataSection" :class="props.data_section_wrapper_class_style">
            ...
            <DataTableSectionUI
                table_id="SchemaAccessDataTable"
...
import SchemaAccessListViewProps       from "./schema_access_list_view_props";
import SchemaAccessListViewController  from "./schema_access_list_view_controller";

const props            = defineProps(SchemaAccessListViewProps);
const controller       = new SchemaAccessListViewController(props)
