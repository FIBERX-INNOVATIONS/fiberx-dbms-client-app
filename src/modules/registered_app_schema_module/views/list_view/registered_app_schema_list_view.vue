...
<template>
    <section id="RegisteredAppSchemaListView" :class="props?.section_wrapper_class_style">
        ...
        <section id="ListDataSection" :class="props.data_section_wrapper_class_style">
            ...
            <DataTableSectionUI
                table_id="RegisteredAppSchemaDataTable"
...
import RegisteredAppSchemaListViewProps       from "./registered_app_schema_list_view_props";
import RegisteredAppSchemaListViewController  from "./registered_app_schema_list_view_controller";

const props            = defineProps(RegisteredAppSchemaListViewProps);
const controller       = new RegisteredAppSchemaListViewController(props)
