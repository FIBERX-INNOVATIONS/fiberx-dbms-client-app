...
class RegisteredAppListViewController extends BaseController {
    ...
    protected getUIStateData(): Record<string, any> {        
        return {
            current_page: ref(1), total_pages: ref(0), total_items: (0), size: (12),
            ...
            bulk_action_dropdown_menu_props: BaseListViewPropsBuilder.getBulkActionMenuListProps(this.bulk_action_btn_id, this.bulk_action_menu_id, this.event_handler, this.content_field_key),
