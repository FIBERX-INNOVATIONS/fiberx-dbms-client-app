...
class BaseFormViewPropsBuilder {
    public readonly name = "base_form_view_props_builder";

    // Method to get an app input group props
    ...
    public static getObjectAddNewFieldBtnProps (event_handler: BaseEventHandlerInterface,): ButtonUIPropsInterface {
        ...
        const loader_content_text   = RenderHtmlUtil.renderLoaderHtml({});
        const on_click              = event_handler?.handleAddNewObjectField.bind(event_handler);
...
export default BaseFormViewPropsBuilder