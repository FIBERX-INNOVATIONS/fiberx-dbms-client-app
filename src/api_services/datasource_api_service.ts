...
class DatasourceAPIService extends BaseAPIService {
    ...
    public async getAllDatasources (params: RequestQueryInputInterface ): Promise<APIResponseInterface<any>> {
    ...
    public async createNewDatasource (form_data: DatasourceFormDataInterface) : Promise<APIResponseInterface<any>> {
    ...
    public async updateDatasource (datasource_id: number, form_data: DatasourceFormDataInterface) : Promise<APIResponseInterface<any>> {
    ...
    public async updateDatasourceState (datasource_id: number) : Promise<APIResponseInterface<any>> {
    ...
    public async deleteDatasource (datasource_id: number) : Promise<APIResponseInterface<any>> {
