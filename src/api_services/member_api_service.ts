...
import { 
    ...
    MemberTwoFactorRecordInterface
...
class MemberAPIService extends BaseAPIService {
    ...
    public async getAllMemberProfileRecords (
        params: RequestQueryInputInterface 
    ): Promise<APIResponseInterface<PaginationResponseInterface<MemberRecordInterface[]>>> {
    ...
    public async getMemberProfileRecord (
    ...
    public async getMember2FAInfo (
        member_public_id: string, 
        hard_reset: boolean = false 
    ): Promise<APIResponseInterface<MemberTwoFactorRecordInterface>> {
    ...
    public async getMemberProfileActivities (
        member_public_id: string, 
        params: RequestQueryInputInterface
    ): Promise<APIResponseInterface<PaginationResponseInterface<MemberActiviityRecordInterface[]>>> {
    ...
    public async createNewMemberProfileRecord (
        form_data: MemberFormDataInputInterface
    ) : Promise<APIResponseInterface<MemberRecordInterface>> {
    ...
    public async updateMemberProfileRecord (
        member_public_id: string, 
        form_data: MemberFormDataInputInterface
    ) : Promise<APIResponseInterface<MemberRecordInterface>> {
    ...
    public async updateMemberAuthRecordState (
        member_public_id: string
    ) : Promise<APIResponseInterface<MemberRecordInterface>> {
