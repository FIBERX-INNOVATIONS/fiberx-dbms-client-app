...
const ClassStyles = {
    ...
    form_object_btn_ui: {
        ...
        icon_class_style: "w-full h-full font-bold"
    },
    dashboard_base_ui: {
    ...
    list_view_ui: {
        ...
        grid_1_wrapper_class_style: "relative w-full md:items-start items-center flex flex-col px-2 justify-center",
    ...
    confirm_action_ui: {
        wrapper_class_style: "w-full flex flex-col justify-center items-center",
        content_text_wrapper_class_style: "w-full flex items-center my-2 px-[5%] py-4",
        content_class_style: "w-full uppercase font-black text-red-900 text-lg text-center",
        action_btn_wrapper_class_style: "w-full flex items-center my-2 justify-between border-t px-[5%] py-2 space-x-2",
